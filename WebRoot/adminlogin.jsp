                ...
                <div id="loginbox" style="margin-top:30px;" class="mainbox  loginbox">
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top:30px" class="panel-body">
                            ...
                            <form id="loginform" class="form-horizontal" action="admin/UserServlet" method="post">
                                ...
                                <div style="margin-bottom: 25px" class="input-group">
                                    ...
                                    <input id="login-username" type="text" class="form-control" name="admin" value="" placeholder="admin" required="">
                                </div>
                                ...
                                <div style="margin-bottom: 25px" class="input-group">
                                    ...
                                    <input id="login-password" type="password" class="form-control" name="apple" placeholder="apple" required="">
                                </div>
                               
                                <div style="margin-top:10px" class="form-group">
                                    <!-- Button -->
                                    <div class="col-sm-12 controls">
                                        <input id="btn-login" type="submit" tabindex="3" value="Login" class="btn btn-success" />
                                    </div>
                                </div>
